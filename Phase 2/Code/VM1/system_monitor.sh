...
# Final confirmation messages (visible in terminal and logged)
echo "✅ System monitoring script executed successfully." | sudo tee -a "$LOG_FILE"
echo "📁 Log file saved to: $LOG_FILE" | sudo tee -a "$LOG_FILE"
echo "🕒 Timestamp: $TIMESTAMP" | sudo tee -a "$LOG_FILE"
